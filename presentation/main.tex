\documentclass[german,10pt]{f1rstlady/templates/presentation}
\usepackage{csquotes}
...
\begin{frame}{\subsecname}
\begin{itemize}
    \item Mit dem Paket \texttt{biblatex} kann man schnell und einfach Literaturverweise einfügen.
        \lstinputlisting[style=custom]{biblatex_preamble.tex}
    \item Die Daten der referenzierten \alert{Literatur} werden in einer \texttt{.bib}\hyp{}Datei
        angegeben:
